...
measure_mode = int(os.environ.get('MMODE', 1))
if measure_mode == 0:
...
print(measures)
tr = transpile_measure_operators(measures, 9, [4, 1])
print(tr)
print("transiled:")
for a, b in zip(measures, tr):
    print(f"{a} -> {b}")
# print(f"projectors:")
...
# backend = Runner("Tuna-9")
freqs = measure(backend, measures, init_state, num_qubits, 2048)
# for i, m in enumerate(measures):
