...
в случае измерения в базисах наблюдаемых $IX, IY, IZ, XI, YI, ZI$. Как и в однокубитном случае, это будут эксперименты с двумя исходами: ${IX, II - IX}, {IY, II- IY}, ...$ Квантовая схема строится так же, как и в первом случае, но преобразования применяется только к одному из кубитов. Например, для $XI$ и $IY$:
```log
XI:
     ┌───┐┌─┐
q_0: ┤ H ├┤M├
